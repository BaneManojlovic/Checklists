...
extension ItemDetailViewController {
    ...
    // MARK: - TableView methods for Date Picker layout
...
extension ItemDetailViewController: UITextFieldDelegate {
    ...
    // MARK: - Fro hiding date picker while editing text field
